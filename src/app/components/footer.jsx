  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 px-4 sm:px-6 lg:px-8">
      <div className=" gap-8 md:gap-12">
        ...
        <div className="col-span-1 md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex space-x-4">
            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 border-1 border-white p-2 rounded-lg hover:bg-zinc-600 hover:text-white transition-colors">
              <Facebook size={24} />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 border-1 border-white p-2 rounded-lg hover:bg-zinc-600 hover:text-white transition-colors">
              <Instagram size={24} />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-400 border-1 border-white p-2 rounded-lg hover:bg-zinc-600 hover:text-white transition-colors">
              <Github size={24} />
            </a>
      ...
      <div className="border-t  border-gray-700 mt-10 pt-8 text-center text-gray-500 text-sm">
        ...
        <p className="mt-2 text-lg">Desenvolvido completamente por <a href="https://github.com/SeuUsuarioGithub" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors border-b-1">André Lucas</a></p>
      </div>
    </footer>
  );
}