            ...
            <div className='w-full lg:w-1/2 min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8'>
                <div className='w-full sm:w-4/5 2xl:w-2/3 rounded-2xl p-6 sm:p-8 lg:p-12 shadow-lg bg-white'>
                    <div className='flex items-center justify-center mb-8 gap-3 sm:gap-4'>
                        ...
                        <h1 className='text-4xl md:text-5xl font-extrabold text-gray-800 tracking-wider'>NEXTBUY</h1>
                    </div>

                    <h2 className='text-2xl md:text-3xl font-bold text-gray-700 mb-8 text-center'>Faça Login para começar</h2>
                    ...
                    <form className='space-y-6' onSubmit={handleSubmit}>
                        <div className='relative'>
                            ...
                            <input
                                ...
                                id="email"
                                placeholder='Email'
                                className='w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 text-lg bg-white'
                            />
                        </div>
                        <div className='relative'>
                        ...
                        <button
                            type="submit"
                            className='w-full cursor-pointer bg-blue-600 text-white py-3.5 rounded-lg font-semibold text-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 shadow-md hover:shadow-lg'
                        >
                            Entrar
                        </button>
