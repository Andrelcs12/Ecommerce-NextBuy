...
const RegisterPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (password.length < 8) {
            alert("Senha deve ter 8 ou mais caracteres");
        } else if (success) {
            alert('Cadastro realizado com sucesso!');
            router.push("/dashboard");
        } else {
            alert('Erro ao cadastrar. Verifique se o email já está em uso.');
            setEmail('');
            setPassword('');
            setConfirmPassword('');
        }
    ...
    return (
        <div className='flex flex-col lg:flex-row w-full min-h-screen font-sans'>
            {/* Seção da ilustração (oculta no mobile, visível em telas grandes) */}
            <div className='hidden lg:flex lg:w-1/2 bg-blue-600 items-center justify-center p-8'>
                <div className='text-white text-center p-8 flex flex-col items-center '>
                    <Image
                        ...
                        height={90} // Mantido para proporção, mas o CSS controla o tamanho real
                        width={500} // Mantido para proporção, mas o CSS controla o tamanho real
            ...
            <div className='w-full lg:w-2/3 xl:w-1/2 min-h-screen flex items-center justify-center '>
                <div className='w-full sm:w-4/5  2xl:w-2/3 rounded-2xl p-6 sm:p-8 lg:p-12 shadow-lg bg-white'>
                    <div className='flex items-center justify-center mb-8 gap-3 sm:gap-4'>
                        ...
                        <h1 className='text-4xl sm:text-5xl font-extrabold text-gray-800 tracking-wider'>NEXTBUY</h1>
                    </div>

                    <h2 className='text-2xl sm:text-3xl font-bold text-gray-700 mb-8 text-center'>Crie sua conta NextBuy</h2>
                    ...
                    <form className='space-y-6' onSubmit={handleSubmit}>
                        ...
                        <div className='flex flex-col xl:flex-row gap-4'>
                            <div className='relative w-full '>
                                ...
                                <input
                                    ...
                                    id="nome"
                                    placeholder='Nome'
                                    className='w-full bg-white pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 text-lg'
                                />
                            </div>
                            <div className='relative w-full'>
                                <User className='absolute left-4 top-1/2 -translate-y-1/2 text-gray-400' size={20} />
                        ...
                        <button
                            type="submit"
                            className='w-full bg-green-600 text-white py-3.5 rounded-lg font-semibold text-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-200 shadow-md hover:shadow-lg cursor-pointer'
                        >
                            Criar Conta
                        </button>
