        ...
        <div className="max-w-5xl w-full bg-white rounded-xl shadow-2xl overflow-hidden md:flex md:min-h-[600px]">
          ...
          <div className="md:w-1/2 p-8 md:p-12 bg-gradient-to-br from-blue-600 to-indigo-700 text-white flex flex-col justify-between items-center text-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <Image src="/image.png" alt="Logo da NextBuy" width={100} height={96} className=" drop-shadow-lg md:size-20 size-12" />
              <h2 className="text-2xl lg:text-4xl font-extrabold mb-4 leading-tight">
                Estamos aqui para você!
              </h2>
              <p className="text-md sm:text-xl opacity-90 mb-8 max-w-md">
            ...
            <div className="relative z-10 space-y-5 text-left w-full max-w-xs md:max-w-sm">
              <div className="flex items-center gap-4">
                ...
                <a href="mailto:apglu.26@gmail.com" className="hover:text-blue-400 underline transition-colors text-lg sm:text-xl font-semibold">apglu.26@gmail.com</a>
              </div>
              <div className="flex items-center gap-4">
                <Phone size={24} className="text-blue-200" />
                 <a href="tel:+5579996021365" className="hover:text-blue-400 underline transition-colors text-lg sm:text-xl font-semibold">(79) 99602-1365</a>
              </div>
              <div className="flex items-start gap-4">
                <MapPin size={24} className="mt-1 text-blue-200 flex-shrink-0" />
                <p className="text-lg sm:text-xl font-semibold">Rua das Flores, 123 - Centro, Aracaju - SE</p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center items-center">
            <h2 className="text-2xl lg:text-4xl font-bold text-gray-800 mb-8 text-center">
              Fale Conosco Diretamente!
            </h2>
            <p className="text-md md:text-xl text-gray-600 mb-8 text-center max-w-md">
